export const abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "toggle", type: "address" },
      {
        indexed: false,
        internalType: "bool",
        name: "mutable_",
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "hatId", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "wearerStanding", type: "bool" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "address", name: "eligibility", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
